...
export default function CartPage({ onBack, onCheckout }) {
    ...
    return (
        <div className="max-w-md mx-auto px-4 pb-[220px] pt-2">
            ...
            <div className="mt-3 glass-card bg-black/80 p-4 border border-black">
            ...
            <div className="mt-3 space-y-2">
                {items.map((it) => (
                    <div
                        key={it._id}
                        className="glass-card bg-black/80 p-4 border border-black"
                    >
                        ...
                        <div className="mt-3 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    className="w-28 rounded-2xl border border-black px-3 py-2 text-sm bg-black/80 text-white"
                                    type="number"
                                    min={1}
                                    value={it.qty}
                                    onChange={(e) =>
            ...
            {items.length > 0 && (
                ...
                >
                    <div className="max-w-md mx-auto px-4">
                        <div className="rounded-3xl bg-black/90 backdrop-blur border border-black shadow-lg p-3">
                            ...
                            <button
                                className="w-full rounded-2xl bg-white text-black py-3.5 text-sm font-medium active:scale-[0.99] transition shadow-lg"
                                onClick={onCheckout}
                            >
                                Оформить
                            </button>
